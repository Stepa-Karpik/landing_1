...
const teamPeople: PersonCard[] = [
  ...
  },
  {
    ...
    role: "Индивидуальный предприниматель / Backend разработчик / менеджмент и управление бизнесом",
    focus: "Связывает бизнес-цели и delivery: фиксирует приоритеты, держит сроки и закрывает backend-контур релиза.",
    stack: "Python · FastAPI · Product Delivery · Management · и др.",
  ...
  },
  {
    ...
    stack: "Python · FastAPI · PostgreSQL · Redis · Docker · и др.",
  ...
  },
  {
    ...
    stack: "Swift · SwiftUI · UIKit · iOS SDK · Xcode · и др.",
  ...
  },
  {
    ...
    stack: "Kotlin · Android · Jetpack Compose · Coroutines · Retrofit · и др.",
  ...
  },
  {
    ...
    stack: "React · Next.js · TypeScript · UI Systems · Motion · и др.",
